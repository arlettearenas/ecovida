    ...
    <body id="body">
        ...
        <div class="container fondo">
            ...
            <div class="row">
                <div class="col-2 offset-10">
                    <div class="text-center">
                        <!-- Boton para modal -->
                        <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#modalEstudio" id="botonCrearE">
            ...
            <div class="table-responsive">
                <table id="estudio" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Nombre</th>
        ...
        <!--Tiene un atributo id con el valor "modalEstudio" que se utiliza para identificarla en el código JavaScript-->
        <div class="modal fade" id="modalEstudio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog"> <!--definen la estructura interna de la ventana modal-->
                <div class="modal-content"> <!--definen la estructura interna de la ventana modal-->
                    ...
                    <form action="V_estudios.php" id="formularioEs" method="POST">
                        <div class="moda-content">
                            <div class="modal-body"> <!--Dentro de modal-body se definen etiquetas <label> y campos de entrada <input>-->
                                ...
                                <label for="abreviatura">Ingrese la abreviatura</label>
                                <input type="text" name="abreviatura" id="abreviatura" class="form-control" autocomplete="off">
                                <br>

                                <label for="toma">Ingrese las tomas</label>
                                <input type="text" name="toma" id="toma" class="form-control" autocomplete="off">
                                <br>

                                <label for="frecuencia">Ingrese la frecuencia</label>
                                <input type="text" name="frecuencia" id="frecuencia" class="form-control" autocomplete="off">
                                <br>

                                <label for="proceso">Ingrese el tipo de proceso</label>
                                <input type="text" name="proceso" id="proceso" class="form-control" autocomplete="off">
                                <br>

                                <label for="muestra">Ingrese el tipo de muestra</label>
                                <input type="text" name="muestra" id="muestra" class="form-control" autocomplete="off">
                                <br>

...
?>
    ...
    <head>
        ...
        <link rel="preload" href="http://localhost/ecovida/css/ejemplo.css" type="text/css" as="style">
        <link rel="stylesheet" href="http://localhost/ecovida/css/ejemplo.css" type="text/css">
